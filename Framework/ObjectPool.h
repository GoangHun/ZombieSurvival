...
public:
	...
	void Init(int casheSize = 100);
	void Release();	//delete 용도
	...
	//void를 반환하고 T*를 매개변수로 쓰는 무명함수를 연결해서 쓰려는 용도
...
template<typename T>
inline void ObjectPool<T>::Init(int casheSize)
{
	Release();
	CreateObjs(casheSize);
}
